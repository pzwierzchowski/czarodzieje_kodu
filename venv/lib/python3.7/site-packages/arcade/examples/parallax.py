...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # --- Background ---
        background = arcade.Sprite("images/_03_distant_trees.png", SPRITE_SCALING)
        background.center_x = background.width / 2
        background.center_y = background.height / 2
        self.background_list.append(background)

        background = arcade.Sprite("images/_01_ground.png", SPRITE_SCALING)
        background.center_x = background.width / 2
        background.center_y = background.height / 2
        self.background_list.append(background)

        background = arcade.Sprite("images/_02_trees and bushes.png", SPRITE_SCALING)
        background.center_x = background.width / 2
        background.center_y = background.height / 2
        self.background_list.append(background)
